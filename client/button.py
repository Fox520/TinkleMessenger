...
from backgroundcolorbehavior import SpecificBackgroundColorBehavior
from ripplebehavior import CircularRippleBehavior, \
    RectangularRippleBehavior
from elevationbehavior import CommonElevationBehavior, \
...
Builder.load_string('''
#:import colors color_definitions.colors
#:import MDLabel label.MDLabel
<BaseButton>:
    size_hint: (None, None)
    anchor_x: 'center'
    anchor_y: 'center'
...
<BaseRoundButton>:
    ...
    MDLabel:
        id: content
        text: "icon_here"#.format(md_icons[root.icon])
